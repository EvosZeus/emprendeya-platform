<div class="container">
    <div class="row">
        <div class="card card-space">
            <h3 class="fw-bold mb-3">Proyectos Exitosos</h3>
            <p class="mb-4">Estos son los proyectos mas Exitosos</p>

            <div class="row mb-4">
                <div class="col-md-6 offset-md-6">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Buscar en proyectos Exitosos...">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <div class="position-absolute top-0 end-0 m-2">
                            <span class="badge bg-warning text-dark">Exitoso</span>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Breve descripción del proyecto destacando su potencial y necesidad de
                                inversión.</p>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card">
                        <div class="position-absolute top-0 end-0 m-2">
                            <span class="badge bg-warning text-dark">Exitoso
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Plataforma para conectar estudiantes y tutores, buscando financiación
                                inicial.</p>
                            <div class="progress mb-2" style="height: 10px;">
